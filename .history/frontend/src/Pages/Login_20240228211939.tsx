const Login: React.FC = () => {
  return (
    <div className="w-full h-full flex items-center justify-center md:px-[14rem] md:py-[8rem] px-[6rem] py-[6rem]">
      <div className="flex flex-col items-start h-[24rem] md:w-[50%] w-[80%] justify-around p-[1rem] border-gray-300 border-[1px] rounded-xl">
