...
import DoctorData, { Doctor } from "../assets/data/doctors.ts";
  ...
  return (
    <section className="p-0 w-full">
      ...
      <section id="show doctors" className="">
        ...
        <div className="flex max-md:flex-col mt-[5rem] w-full justify-between max-md:items-center max-md:gap-[3rem]"></div>
      </section>
    </section>
  );
};
