...
const Signup: React.FC = () => {
  ...
  const setUserOnSingup = (data) => {
    useDispatchTyped(userActions.login(data));
  };
  ...
  const submitHandler = async (event: FormEvent) => {
    ...
    imageData.append("cloud_name", "dlfyo8jcv");
      ...
      <div className="flex flex-col items-start justify-around p-8 h-full max-sm:justify-between w-full  gap-7">
        ...
        >
          ...
          <button className="btn w-[80%] py-3 mx-auto">
            {isPending ? <ClipLoader size={15} /> : "Sign Up"}
          </button>
        </form>
