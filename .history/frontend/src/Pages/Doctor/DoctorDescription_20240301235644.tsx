  ...
  return (
    <section className="flex w-full max-md:flex-col  px-[2rem] py-[3rem] h-[92vh]">
      <div className="w-[60%] px-[6rem]">
        ...
        <div className="flex items-center justify-start gap-[2rem] mt-[3rem] border-b-4 py-[0.2rem]">
          <button
            className={`${
              isAbout ? "border-2 rounded-lg bg-primaryColor text-white" : ""
            } p-[0.7rem] font-[600]`}
            onClick={() => setIsAbout((pre) => !pre)}
          >
            About
          </button>
          <button
