...
const DoctorDescription: React.FC = () => {
  ...
  return (
    <section className="flex w-full max-md:flex-col px-[2rem] py-[2rem] h-[92vh]">
      <div className="lg:w-[60%] px-[6rem]">
        ...
        <div className="flex items-center justify-start gap-[2rem] mt-[1.7rem] border-b-4 py-[0.4rem]">
          <button
            className={`${
              isAbout === "About"
