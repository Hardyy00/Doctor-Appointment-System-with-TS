    ...
    <section className="w-full py-[3rem] text-textColor">
      <div className="mx-auto lg:w-[70%] flex max-md:flex-col max-md:items-center ">
        <div className="h-full lg:w-[40%] w-[80%]">
          <div className="flex flex-col w-[90%] mx-auto my-[4rem] p-[1rem] text-center shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-md pb-[2rem]">
