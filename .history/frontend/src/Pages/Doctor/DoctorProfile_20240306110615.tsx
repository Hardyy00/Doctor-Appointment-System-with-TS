    ...
    <section className="w-full py-[3rem]">
      <div className="mx-auto w-[70%] flex border-2 border-black">
        <div className="h-full border-2 border-black w-[40%]">
          <div className="flex flex-col w-[90%] mx-auto my-[4rem] p-[1rem] text-center shadow-[shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px]]">
            <ul>
              <li>Overview</li>
              <li>Appointments</li>
              <li>Profile</li>
