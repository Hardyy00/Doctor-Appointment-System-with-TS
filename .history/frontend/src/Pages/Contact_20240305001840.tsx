      ...
      <form action="" className="mx-auto w-[50%] flex flex-col gap-[1.5rem] ">
        <div className="contact_row">
          ...
          <input
            ...
            name="email"
            id="email"
            className="w-full border-[3px] border-gray outline-none focus:outline-none rounded-lg px-[1rem] py-[0.8rem] tracking-wide focus:border-primaryColor text-[1.2rem]"
          />
        </div>
