...
const DoctorSearch: React.FC = () => {
  return (
    <section className="w-full h-[87vh] border-2 p-0">
      <article className="w-full flex flex-col items-center justify-center gap-[3rem]  bg-gradient-to-r from-rose-400 to-red-500">
