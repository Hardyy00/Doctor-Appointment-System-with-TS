...
const Profile: React.FC = () => {
  ...
  return (
    <section className="border-2  px-[6rem] pb-[5rem] pt-[3rem] flex justify-center">
      <div className="flex border-2 border-black w-[70%] p-[1rem]">
        <div className="flex flex-col w-[40%] border-black border-2 items-center justify-between gap-[10rem]">
