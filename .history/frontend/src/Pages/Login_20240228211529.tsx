const Login: React.FC = () => {
  return (
    <div className="w-full h-full flex items-center justify-center md:px-[14rem] md:py-[8rem] py-[6rem]">
      <div className="flex flex-col items-start h-[24rem] w-[50%] max-sm:w-[80%] justify-around p-[1rem] border-gray-300 border-[1px] rounded-xl max-sm:w-[]">
