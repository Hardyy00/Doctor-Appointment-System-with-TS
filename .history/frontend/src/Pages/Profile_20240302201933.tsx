...
const Profile: React.FC = () => {
  ...
  return (
    <section className="border-2  px-[6rem] pt-[3rem] flex justify-center">
      <div className="flex max-md:flex-col border-2 border-black w-[70%] p-[1rem]">
        <div className="flex flex-col w-[40%]  items-center justify-between gap-[8rem]">
          ...
          <div className="flex flex-col w-full items-center gap-4">
            <button className="w-[90%] bg-textColor py-[1rem] rounded-lmd">
              Logout
            </button>
