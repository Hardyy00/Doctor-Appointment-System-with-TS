...
const Profile: React.FC = () => {
  ...
  return (
    <section className=" px-[6rem] pb-[5rem] pt-[2rem] flex justify-center text-textColor">
      <div className="flex max-md:flex-col w-[100%] lg:p-[1rem] justify-around max-md:justify-center max-md:item-center max-md:gap-[3rem]">
        ...
        <div className="flex flex-col w-[40%] max-md:w-full gap-[2rem]">
