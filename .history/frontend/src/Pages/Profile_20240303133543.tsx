...
const Profile: React.FC = () => {
  ...
  return (
    <section className=" px-[6rem] pb-[5rem] pt-[2rem] flex justify-center text-textColor">
      <div className="flex max-md:flex-col w-[100%] p-[1rem] justify-around max-md:justify-center max-md:item-center">
        <div className="flex flex-col w-[30%] h-[26rem]  items-center justify-between">
        ...
        <div className="flex flex-col w-[40%] gap-[2rem]">
