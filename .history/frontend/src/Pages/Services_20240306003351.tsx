  ...
  return (
    <div className="flex flex-col gap-4 text-textColor">
      ...
      <div className="flex items-center justify-between h-[2rem]">
        ...
        <p
          className={`h-full w-[2rem] flex items-center justify-center bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent font-[800] text-[1.3rem] hover:${hov}`}
        >
          {index}
        </p>
      </div>
