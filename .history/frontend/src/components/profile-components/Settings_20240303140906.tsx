    ...
    <div className="flex flex-col gap-[2rem]">
      ...
      <form className="w-full flex flex-col gap-[2rem]">
        ...
        <div className="flex items-center gap-[1rem]">
          <div className="w-[3rem] h-[3rem] bg-red-300 rounded-[50%] border-2 border-primaryColor">
            <img src="" alt="" className="object-cover h-full" />
          </div>

          <div>
            <button className="p-[1rem] bg-primaryColor/20 rounded-lg text-primaryColor font-[700]">
              Upload photo
            </button>
          </div>
        </div>
