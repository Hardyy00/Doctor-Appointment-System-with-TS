...
const Footer: React.FC = () => {
  return (
    <div className="w-full py-[1rem] px-[3rem] flex max-sm:flex-col border-t-2 border-t-gray-400  items-center justify-around pb-10">
      ...
      <div className="flex flex-col h-full gap-7">
        ...
        <ul className="list">
          <li className="member">Home</li>
          <li className="member">About</li>
          <li className="member">Services</li>
          <li className="member">Blog</li>
        </ul>
      </div>
      ...
      <div className="flex flex-col h-full gap-7">
        ...
        <ul className="list">
          <li className="member">Find a Doctor</li>
          <li className="member">Request an Appointment</li>
          <li className="member">Find a Location</li>
          <li className="member">Get an Opinion</li>
        </ul>
      </div>
      ...
      <div className="flex flex-col h-full gap-7 justify-start">
        ...
        <ul className="list">
          <li className="member">Donate</li>
          <li className="member">Contact Us</li>
