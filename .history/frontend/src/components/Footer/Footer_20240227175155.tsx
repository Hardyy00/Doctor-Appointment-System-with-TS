...
const Footer: React.FC = () => {
  return (
    <div className="w-full py-[1rem] px-[3rem] flex max-sm:flex-col border-black  border-2 items-center justify-around box-content">
      ...
      <div className="flex flex-col gap-4 h-[1rem] justify-center">
        <h3>Support</h3>
        <ul className="list">
          <li>Donate</li>
          <li>Contact Us</li>
