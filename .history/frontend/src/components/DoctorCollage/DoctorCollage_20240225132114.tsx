...
const DoctorCollage: React.FC = () => {
  return (
    <div className="relative sm:flex sm:flex-col">
      <div className="w-[16rem] md:h-[22rem] h-[18rem] md:absolute rounded-xl right-[20rem] top-[10rem] z-10">
        <img
          src={Doc}
          alt=""
      ...
      <div className="w-[16rem] md:h-[16rem] h-[12rem] rounded-xl absolute right-[10rem] sm:top-[0]">
        <img
          src={Doc3}
          alt=""
          className="w-[16rem] rounded-xl md:h-[16rem] h-[12rem] sm:top-[0rem]"
        />
      </div>
    </div>
  );
