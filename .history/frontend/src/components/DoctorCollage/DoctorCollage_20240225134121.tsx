...
const DoctorCollage: React.FC = () => {
  return (
    <div className="relative max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center">
      ...
      <div className="w-[16rem] md:h-[16rem] h-[12rem] rounded-xl absolute md:right-[7rem] md:top-4 sm:hidden">
        <img
          src={Doc3}
          alt=""
          className="w-[16rem] rounded-xl md:h-[16rem] h-[12rem] max-sm:[]"
        />
      </div>
    </div>
  );
