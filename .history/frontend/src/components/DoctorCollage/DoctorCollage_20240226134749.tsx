...
const DoctorCollage: React.FC = () => {
  return (
    <div className="big grid-cols-2  grid gap-x-0 md:w-[65%]">
      <div className="w-full max-sm:h-[14rem] w-full h-52">
        <img src={Doc} alt="" className="w-full max-sm:h-[14rem] h-[26rem]" />
      </div>

      <div className="max-sm:w-full max-sm:h-[14rem] h-full">
