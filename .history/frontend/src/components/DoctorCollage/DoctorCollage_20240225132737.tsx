...
const DoctorCollage: React.FC = () => {
  return (
    <div className="relative sm:flex sm:flex-col">
      ...
      <div className="w-[16rem] md:h-[16rem] h-[12rem] rounded-xl md:absolute right-[4rem] top-[12rem] ml-3">
        <img
          src={Doc2}
          alt=""
      ...
      <div className="w-[16rem] md:h-[16rem] h-[12rem] rounded-xl absolute md:right-[10rem] sm"top-[9rem] sm:left-[10rem]">
        <img
          src={Doc3}
          alt=""
          className="w-[16rem] rounded-xl md:h-[16rem] h-[12rem]"
