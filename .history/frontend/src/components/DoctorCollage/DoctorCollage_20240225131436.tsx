...
const DoctorCollage: React.FC = () => {
  return (
    <div className="md:relative">
      <div className="sm:flex sm:flex-col h-[100%]">
        <div className="w-[16rem] absolute rounded-xl right-[20rem] top-[10rem] z-10">
          <img src={Doc} alt="" className="w-[16rem] rounded-xl h-[22rem]" />
        </div>

        <div className="w-[16rem] rounded-xl absolute right-[4rem] top-[12rem]">
