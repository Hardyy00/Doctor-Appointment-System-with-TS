import DoctorCollage from "../DoctorCollage/DoctorCollage";
import { FaArrowDown } from "react-icons/fa";
const Hero: React.FC = () => {
  return (
    <main className="flex flex-col md:flex-row h-full justify-between gap-12 w-[100%] md:px-24 py-8 md:h-[90vh] lg:[90vh] home px-">
