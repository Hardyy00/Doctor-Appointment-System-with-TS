...
const BookDoctor: React.FC<{ doctor: Doctor }> = ({ doctor }) => {
  return (
    <div className="px-[1rem] w-[22rem] py-[1rem] h-auto box-decoration-slice text-textColor flex flex-col gap-[2rem]">
      ...
      <button className="btn p-[1rem]">Book Appointment</button>
    </div>
  );
};
