...
const Header: React.FC = () => {
  ...
  return (
    <section className="header flex items-center md:justify-center sm:justify-between">
      <div className="container ">
        <div className="flex items-center justify-between gap-[1rem]">
          ...
          <div className="flex items-center gap-4">
            <figure className="w-12 h-12 md:w-14 md:h-14 flex items-center rounded-full hidden">
